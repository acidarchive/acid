INSERT INTO patterns_tb303 (
    pattern_id, user_id, author, title, description, triplets, bpm, waveform,
    cut_off_freq, resonance, env_mod, decay, accent, updated_at, created_at
) VALUES (
...
INSERT INTO steps_tb303 (
    step_id, pattern_id, number, note, octave, "time", accent, slide, updated_at, created_at
) VALUES
